...
public abstract class Vehicle {
    ...
    public static Vehicle fromCSVLine(String line) {
        ...
        return switch (data[0]) {
            ...
            case "MOTORCYCLE" -> new Motorcycle(data[1], data[2], data[3], Integer.parseInt(data[4]), Double.parseDouble(data[5]), Boolean.parseBoolean(data[6]), MotorcycleCategory.valueOf(data[7].toUpperCase()));
            default -> null;
        };
    }
