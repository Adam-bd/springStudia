...
#### **Implementacja interfejsu IVehicleRepositoryImpl**
- Z listą pojazdów.
...
#### **Klasa, która umożliwi interakcję z użytkownikiem**
pozwoli wyświetlić infromacje o pojazdach, wypożyczyć i zwrócić pojazd (UI konsolowe).
